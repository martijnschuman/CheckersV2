...
namespace CheckersAPI.Migrations
{
    /// <inheritdoc />
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    MultiFactorPrivateKey = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentPlayerTurnId = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckerGames", x => x.GameId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CheckerPieceId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    IsKing = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CheckerGameGameId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckersPiece", x => x.CheckerPieceId);
                    table.ForeignKey(
                        name: "FK_CheckersPiece_CheckerGames_CheckerGameGameId",
                        column: x => x.CheckerGameGameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckersPiece_CheckerGameGameId",
                table: "CheckersPiece",
                column: "CheckerGameGameId");
        }
